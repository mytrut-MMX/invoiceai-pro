...
const HINT = {
  office:       "Stationery, printer ink, desk accessories. Not: furniture over £500 (capital asset)",
  travel:       "Train tickets, mileage (45p/mile first 10k), parking. Not: daily commute",
  professional: "Accountant, solicitor, professional memberships, training courses",
  marketing:    "Ads, website hosting, business cards. Not: client entertainment (disallowed by HMRC)",
  rent:         "Office rent, business rates, co-working space. Home office: use HMRC flat rate",
  ...
  software:     "SaaS tools, cloud storage, design software",
  bank:         "Transaction fees, Stripe/PayPal fees, account charges",
  equipment:    "Laptops, monitors, tools under £500. Over £500: capital allowance",
  wages:        "Employee pay, employer NIC, pension contributions",
  training:     "Courses, certifications, conferences, books directly related to your trade",
  motor:        "Fuel for business trips, vehicle insurance, MOT. Not: personal use portion",
  repairs:      "Office repairs, equipment servicing, website fixes",
  costOfSales:  "Materials, subcontractor costs, direct production costs",
  uncat:        "Temporary — assign a proper category before tax filing",
  meals:        "Client meals on business trips, overnight subsistence. Not: everyday lunches",
  entertain:    "Client entertainment is not tax-deductible (HMRC disallowed). Record for accounts, not relief",
  postage:      "Royal Mail, couriers, shipping supplies, franking",
};

const CATEGORY_HINTS = {
  // Keys from the original spec
  "Office & Supplies":        HINT.office,
  "Travel":                   HINT.travel,
  "Professional Fees":        HINT.professional,
  "Marketing":                HINT.marketing,
  "Rent & Rates":             HINT.rent,
  "Utilities":                HINT.utilities,
  "Insurance":                HINT.insurance,
  "Software & Subscriptions": HINT.software,
  "Bank Charges":             HINT.bank,
  "Equipment":                HINT.equipment,
  "Wages & Salaries":         HINT.wages,
  "Training & Development":   HINT.training,
  "Motor Expenses":           HINT.motor,
  "Repairs & Maintenance":    HINT.repairs,
  "Cost of Sales":            HINT.costOfSales,
  "Uncategorised":            HINT.uncat,
  // Aliases matching actual EXPENSE_CATEGORIES dropdown names
  "Advertising":              HINT.marketing,
  "Automobile":               HINT.motor,
  "Fuel":                     HINT.motor,
  "Office Supplies":          HINT.office,
  "Stationery":               HINT.office,
  "Professional Services":    HINT.professional,
  "IT & Software":            HINT.software,
  "Subscriptions":            HINT.software,
  "Subcontractor Labour":     HINT.costOfSales,
  "Subcontractor Materials":  HINT.costOfSales,
  "Other":                    HINT.uncat,
  "Meals & Subsistence":      HINT.meals,
  "Client Entertainment":     HINT.entertain,
  "Postage & Courier":        HINT.postage,
};
