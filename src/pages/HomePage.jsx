                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        padding:"11px 16px",
                        background: s.bg,
                        borderBottom: idx < visibleAlerts.length - 1 ? `1px solid ${s.border}` : "none",
                      }}
                    >
                      {/* Left: dot + text */}
                      <div style={{ display:"flex", alignItems:"flex-start", gap:10, flex:1, minWidth:0 }}>
                        ...
                        <div style={{ minWidth:0 }}>
                          <div style={{ display:"flex", alignItems:"center", gap:6, flexWrap:"wrap", marginBottom:1 }}>
                            ...
                            <span style={{ fontSize:10, fontWeight:700, color:s.labelColor, textTransform:"uppercase", letterSpacing:"0.05em" }}>
                              {s.label}
                            </span>
                          </div>
                          {alert.description && (
                            <div style={{ fontSize:11, color:"#6b7280" }}>{alert.description}</div>
                          )}
                        </div>
                      </div>
